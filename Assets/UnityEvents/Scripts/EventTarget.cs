...
namespace UnityEvents
{
	...
	public struct EventTarget: IEquatable<EventTarget>
	{
		...
		public static EntityTargetReservation ReserveTargets(ulong count)
		{
			ulong start = _ids;
			...
			return new EntityTargetReservation(start, count);
		}
	...
	/// </summary>
	public struct EntityTargetReservation : IEquatable<EntityTargetReservation>
	{
		...
		public EntityTargetReservation(ulong reservationStart, ulong reservationCount)
		{
		...
		public bool Equals(EntityTargetReservation other)
		{
		...
		{
			if (ReferenceEquals(null, obj)) return false;
			return obj is EntityTargetReservation other && Equals(other);
		}
